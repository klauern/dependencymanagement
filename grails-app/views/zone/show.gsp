                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:zoneInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Zoneusage:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:zoneInstance, field:'zone_usage')}</td>
